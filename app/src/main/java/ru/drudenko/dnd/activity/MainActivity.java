...
public class MainActivity extends AppCompatActivity implements UpdateNotice {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_all_spells, R.id.nav_all_monsters, R.id.nav_master_help, R.id.nav_profiles, R.id.nav_randoms, R.id.nav_class_master_help, R.id.nav_race_master_help)
